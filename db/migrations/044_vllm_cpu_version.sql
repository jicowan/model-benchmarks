...
--                      that may not track the GPU tag). Default = the validated
--                      pin, v0.11.2 (first prebuilt Arm CPU wheels/images).
--
...
ALTER TABLE tool_versions
    ADD COLUMN IF NOT EXISTS vllm_cpu_version TEXT NOT NULL DEFAULT 'v0.11.2';
